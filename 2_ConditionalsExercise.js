...
function exercise1(num1) {
  ...
  // varA and varB seem equal if one is a string value of 5 and the other is a number 5, the typeof method would return different data types. If both were booleans they would have the same datatype but possibly different value of false or true.
